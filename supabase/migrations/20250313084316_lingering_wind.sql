/*
  ...
  1. Changes
    ...
    - Set up RLS policies
    - Create triggers for automatic balance management

  2. Tables
    - leave_types: Define available leave types
    - leave_balances: Track employee leave balances
    - leave_requests: Store leave applications
*/
...
DROP COLUMN IF EXISTS leave_type_id CASCADE;
